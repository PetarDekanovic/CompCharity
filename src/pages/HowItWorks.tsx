  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <h1 className="text-7xl md:text-8xl font-bold tracking-tighter text-gray-900 leading-[0.85] mb-12">
                Simple. Secure. <br />
                <span className="text-blue-600 italic font-serif">Impactful.</span>
              </h1>
      ...
      <section className="py-32 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-100 border border-gray-100 rounded-[48px] overflow-hidden shadow-2xl shadow-gray-100">
            {steps.map((step, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <div className="text-5xl font-bold text-gray-100 group-hover:text-blue-600/10 transition-colors mb-8">
                  {step.step}
                </div>
                <div className={`w-16 h-16 rounded-2xl bg-${step.color}-50 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform`}>
          ...
          <div className="space-y-48">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div className="space-y-8">
                ...
                <h2 className="text-5xl font-bold tracking-tighter text-gray-900">The Donation Path</h2>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-[40px] shadow-xl border border-gray-50 max-w-xs">
                  ...
                  <div className="text-sm font-bold text-gray-400 uppercase tracking-widest">Digital Inclusion Focus</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div className="order-2 lg:order-1 relative">
                ...
                <div className="absolute -top-10 -right-10 bg-white p-8 rounded-[40px] shadow-xl border border-gray-50 max-w-xs">
                  <div className="text-4xl font-bold text-purple-600 mb-2">ROI</div>
                  <div className="text-sm font-bold text-gray-400 uppercase tracking-widest">Maximize Asset Value</div>
                </div>
              </div>
              <div className="order-1 lg:order-2 space-y-8">
                <div className="w-16 h-16 bg-purple-600 rounded-2xl flex items-center justify-center shadow-xl shadow-purple-200">
                  <Recycle className="w-8 h-8 text-white" />
                </div>
                <h2 className="text-5xl font-bold tracking-tighter text-gray-900">The Resale Path</h2>
                <p className="text-xl text-gray-500 font-medium leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-6 bg-white rounded-3xl border border-gray-100">
                    <div className="text-2xl font-bold text-purple-600 mb-1">Fair Market</div>
                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Valuation</div>
                  </div>
                  <div className="p-6 bg-white rounded-3xl border border-gray-100">
                    <div className="text-2xl font-bold text-purple-600 mb-1">Global</div>
                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Resale Network</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-900 rounded-[64px] p-16 md:p-24 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <Link
                  to="/donate"
                  className="bg-blue-600 text-white px-12 py-6 rounded-3xl font-bold text-lg hover:bg-blue-700 transition-all shadow-2xl shadow-blue-900/40"
                >
                  Donate Tech
                </Link>
                <Link
