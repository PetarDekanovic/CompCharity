          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <h1 className="text-7xl md:text-8xl font-bold tracking-tighter text-gray-900 leading-[0.85] mb-12">
                Get in <br />
                <span className="text-blue-600 italic font-serif">Touch.</span>
              </h1>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-[40px] shadow-xl border border-gray-50 max-w-xs">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center">
                    <Clock className="w-6 h-6 text-blue-600" />
                  </div>
                  <div className="text-sm font-bold text-gray-900 uppercase tracking-widest">Fast Response</div>
                </div>
                <div className="text-3xl font-bold text-gray-900">Within 24 Hours</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
            ...
            <div className="lg:col-span-4 space-y-12">
              <div className="sticky top-32">
                <h2 className="text-4xl font-bold tracking-tighter text-gray-900 mb-12">Our Offices</h2>
                <div className="space-y-12">
                  <div className="p-8 bg-white rounded-[40px] shadow-xl shadow-gray-200/50 border border-gray-100">
                    <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center mb-6">
                      <MapPin className="w-6 h-6 text-blue-600" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Main Hub</h3>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="p-6 bg-white rounded-3xl border border-gray-100">
                      ...
                      <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Partnerships</div>
                    </div>
                    <div className="p-6 bg-white rounded-3xl border border-gray-100">
            ...
            <div className="lg:col-span-8">
              <div className="bg-white rounded-[64px] p-12 md:p-20 shadow-2xl shadow-gray-200/50 border border-gray-100">
                {isSuccess ? (
                  <div className="text-center py-12">
                    <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-8">
                      <Send className="w-12 h-12 text-green-600" />
                    </div>
                    <h2 className="text-4xl font-bold tracking-tighter text-gray-900 mb-4">Message Sent!</h2>
                    <p className="text-xl text-gray-500 font-medium mb-12">Thank you for reaching out. Our team will get back to you shortly.</p>
                    <button
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        ...
                        <input
                          {...register("name")}
                          className="w-full px-8 py-6 rounded-3xl bg-gray-50 border border-transparent focus:bg-white focus:border-blue-500 outline-none transition-all font-medium"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <label className="text-sm font-bold text-gray-400 uppercase tracking-widest">Phone (Optional)</label>
                        <input
                          {...register("phone")}
                          className="w-full px-8 py-6 rounded-3xl bg-gray-50 border border-transparent focus:bg-white focus:border-blue-500 outline-none transition-all font-medium"
                          placeholder="+353 ..."
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-bold text-gray-400 uppercase tracking-widest">Enquiry Type</label>
                        <select
                          {...register("type")}
                          className="w-full px-8 py-6 rounded-3xl bg-gray-50 border border-transparent focus:bg-white focus:border-blue-500 outline-none transition-all font-medium appearance-none"
                        >
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        {...register("message")}
                        rows={6}
                        className="w-full px-8 py-6 rounded-3xl bg-gray-50 border border-transparent focus:bg-white focus:border-blue-500 outline-none transition-all font-medium resize-none"
