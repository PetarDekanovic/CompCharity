          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <h1 className="text-7xl md:text-8xl font-bold tracking-tighter text-gray-900 leading-[0.85] mb-12">
                Resell Your <br />
                <span className="text-purple-600 italic font-serif">Tech.</span>
              </h1>
              ...
              <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-purple-600 rounded-2xl flex items-center justify-center shadow-xl shadow-purple-200 shrink-0">
                    <Wallet className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900">Shared Proceeds</h3>
                    <p className="text-sm text-gray-500 font-medium">Keep a portion or donate it all.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-gray-900 rounded-2xl flex items-center justify-center shadow-xl shadow-gray-200 shrink-0">
                    <ShieldCheck className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900">Secure Selling</h3>
                    <p className="text-sm text-gray-500 font-medium">We handle listing & data wiping.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-8 rounded-[40px] shadow-xl border border-gray-50 max-w-xs">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center">
                    <TrendingUp className="w-6 h-6 text-green-600" />
                  </div>
                  <div className="text-sm font-bold text-gray-900 uppercase tracking-widest">Market Value</div>
                </div>
                <div className="text-3xl font-bold text-gray-900">Top Tier Pricing</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
            ...
            <div className="lg:col-span-4 space-y-12">
              <div className="sticky top-32">
                <h2 className="text-4xl font-bold tracking-tighter text-gray-900 mb-12">How it works</h2>
                <div className="space-y-12">
                  {[
                    ...
                    <div key={i} className="flex gap-8 group">
                      <div className="text-2xl font-bold text-gray-200 group-hover:text-purple-600 transition-colors">
                        {item.step}
                      </div>
                      <div>
                ...
                <div className="mt-16 p-8 bg-gray-900 rounded-[40px] text-white relative overflow-hidden">
            ...
            <div className="lg:col-span-8">
              <div className="bg-white rounded-[64px] p-12 md:p-20 shadow-2xl shadow-gray-200/50 border border-gray-100">
                <div className="max-w-2xl mx-auto">
                  <div className="mb-12">
                    <h2 className="text-4xl font-bold tracking-tighter text-gray-900 mb-4">Device Submission</h2>
                    <p className="text-gray-500 font-medium">Please provide as much detail as possible for an accurate valuation.</p>
                  </div>
      ...
      <section className="py-32 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold tracking-tighter text-gray-900">Why Resell with Us?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="text-center space-y-6">
                <div className="w-20 h-20 bg-gray-50 rounded-[32px] flex items-center justify-center mx-auto group-hover:scale-110 transition-transform">
